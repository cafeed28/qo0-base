...
namespace D
{
	...
	void AddDrawListText(ImDrawList* pDrawList, ImFont* pFont, const float flFontSize, const ImVec2& vecPosition, const char* szText, const Color_t& colText, const unsigned int uFlags = DRAW_TEXT_NONE, const Color_t& colOutline = Color_t(0, 0, 0, 255), const float flThickness = 1.0f);
