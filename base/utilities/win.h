...
struct _LDR_DATA_TABLE_ENTRY32
{
	...
	uint32_t Flags; // 0x34
	uint16_t ObsoleteLoadCount; // 0x38
	uint16_t TlsIndex; // 0x3A - always
	...
	uint32_t OriginalBase; // 0x80
	int64_t LoadTime; // 0x84
	uint32_t BaseNameHashValue; // 0x90
	uint32_t LoadReason; // 0x94
	uint32_t ImplicitPathOptions; // 0x98
	uint32_t ReferenceCount; // 0x9C
};
...
struct _PEB_LDR_DATA32
{
	...
	uint8_t ShutdownInProgress; // 0x28
...
struct _RTL_USER_PROCESS_PARAMETERS32
{
	...
	uint32_t StartingX; // 0x4C
	uint32_t StartingY; // 0x50
	uint32_t CountX; // 0x54
	uint32_t CountY; // 0x58
	uint32_t CountCharsX; // 0x5C
	uint32_t CountCharsY; // 0x60
	uint32_t FillAttribute; // 0x64
	uint32_t WindowFlags; // 0x68
	uint32_t ShowWindowFlags; // 0x6C
	...
	uint32_t EnvironmentSize; // 0x290
	uint32_t EnvironmentVersion; // 0x294
	void* PackageDependencyData; // 0x298
	uint32_t ProcessGroupId; // 0x29C
	uint32_t LoaderThreads; // 0x2A0
};
...
struct _PEB32
{
	...
	uint32_t SystemReserved[1]; // 0x30
	...
	uint64_t AppCompatFlags; // 0x1D8
	uint64_t AppCompatFlagsUser; // 0x1E0
...
struct _CLIENT_ID32
{
	uint32_t UniqueProcess; // 0x0
	uint32_t UniqueThread; // 0x4
};
static_assert(sizeof(_CLIENT_ID32) == 0x8);

struct _GDI_TEB_BATCH32
{
	uint32_t Offset : 31; // 0x0
	uint32_t HasRenderingCommand : 1; // 0x0
	uint32_t HDC; // 0x4
	uint32_t Buffer[310]; // 0x8
};
...
struct _TEB32
{
	...
	int32_t ExceptionCode; // 0x1A4
	struct _ACTIVATION_CONTEXT_STACK* ActivationContextStackPointer; // 0x1A8
	uint32_t InstrumentationCallbackSp; // 0x1AC
	uint32_t InstrumentationCallbackPreviousPc; // 0x1B0
	uint32_t InstrumentationCallbackPreviousSp; // 0x1B4
	uint8_t InstrumentationCallbackDisabled; // 0x1B8
	uint8_t SpareBytes[23]; // 0x1B9
	...
	uint32_t Win32ClientInfo[62]; // 0x6CC
	void* glDispatchTable[233]; // 0x7C4
	uint32_t glReserved1[29]; // 0xB68
	...
	uint32_t ReservedForCodeCoverage; // 0xF8C
	...
	uint16_t HeapVirtualAffinity; // 0xFA8
	uint16_t LowFragHeapDataSlot; // 0xFAA
	...
	int32_t WowTebOffset; // 0xFDC
	void* ResourceRetValue; // 0xFE0
	void* ReservedForWdf; // 0xFE4
	uint64_t ReservedForCrt; // 0xFE8
